...
public class DeveloperDB {
	...
	private DeveloperDB() {
		// 초기 개발자 데이터 추가
		String[] frontSkills = { "Java", "CSS/HTML", "JavaScript" };
		String[] backSkills = { "Java", "Spring", "Oracle" };
		String[] serverSkills = { "Oracle", "Maria", "Python" };
		developers.add(new Developer("Arthur", frontSkills, 5));
		developers.add(new Developer("Beckham", backSkills, 3));
		developers.add(new Developer("Cameron", serverSkills, 7));
	}
